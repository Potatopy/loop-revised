# Copy and Pasted from https://github.com/SamSanai/VoiceMaster-Discord-Bot
...
class JTC(commands.Cog):
    ...
    async def help(self, ctx):
        em = nextcord.Embed(title="VoiceMaster Help", description="**Commands:**", color=0x00ff00)
        em.add_field(name=f"**{p}voice help**", value="Shows this message", inline=False)
        em.add_field(name=f"**{p}voice setup**", value="Sets up VoiceMaster for you!", inline=False)
        em.add_field(name=f"**{p}voice name**", value="Sets the name of your channel", inline=False)
        em.add_field(name=f"**{p}voice setlimit**", value="Sets the limit of your channel", inline=False)
        em.add_field(name=f"**{p}voice setup**", value="Sets up the bot in your server", inline=False)
        em.add_field(name=f"**{p}voice lock**", value="Locks your current channel", inline=False)
        em.add_field(name=f"**{p}voice unlock**", value="Unlocks your current channel", inline=False)
        em.add_field(name=f"**{p}voice permit**", value="Allow a user into your voice channel", inline=False)
        em.set_footer(text="VoiceMaster by [this dude](https://github.com/SamSanai/VoiceMaster-Discord-Bot)")
